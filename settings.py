...
CHANNEL_ID =  # id канала куда будет отсылаться информация, ид без -100 в начале (например: 124873248) - указать заместо нуля
...
# инфа
info = f''' ❗Если у вас возникла проблема с оплатой, пишите сюда: <b>@</b>\n
❓По всем остальным вопросам: <b>@</b>  
 \n'''
...
card_balance=f'➕ <b>Пополнение баланса</b>\n\n' \
              f'💵 <u>Пополнение баланса через карту</u>\n\n' \
                '➖➖➖➖➖➖➖➖➖➖\n\n' \
                f'💳<b>Номер карты для пополнения:</b> <code></code> \n\n' \
                '➖➖➖➖➖➖➖➖➖➖\n\n' \
...
renish_balance=f'➕ <b>Пополнение баланса</b>\n\n' \
                     ...
                     '➖➖➖➖➖➖➖➖➖➖\n\n'\
                     f'<b>Номер счета для пополнения: </b><code></code>\n\n' \
